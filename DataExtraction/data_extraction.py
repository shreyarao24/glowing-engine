...
f = pandas.read_csv('C:/Users/Shreya/Downloads/file-name.csv', header=None)
...
for row in f.itertuples():
    ...
    if r[0].isnumeric() and len(r) >= 3:
        if 'General' not in r and 'OBC(Category' not in r and 'ST' not in r:
            sr_no = r[0]
